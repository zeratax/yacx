...
public class Executor {
    ...
    public static KernelTime launch(String kernelString, String kernelName, String deviceName, Options options, int grid, int block, KernelArg ...args) {
    	if (!load) loadLibary();
    ...
    public static KernelTime launch(String kernelString, String kernelName, String deviceName, Options options, int grid0, int grid1, int grid2, int block0, int block1, int block2, KernelArg ...args) {
    	if (!load) loadLibary();
