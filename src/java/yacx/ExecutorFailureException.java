 ...
 * Especially errors while compiling kernel with nvrtc or while using CUDA
 * driver api create this Exception. <br>
 * Errors like segmentation faults (e.g. passing invalid arguments to CUDA
 * kernel) are <strong>not</strong> caught and will crash the execution of the
 * running program.
 */
