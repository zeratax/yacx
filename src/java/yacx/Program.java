...
public class Program extends JNIHandle {
     ...
     * @param templateParameter template parameters which should be used for this Program
     ...
     * @param templateParameter template parameter which should be used for this Program
     */
