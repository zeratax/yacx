...
public class CProgram extends JNIHandle {
	...
	public static CProgram create(String cProgram, String functionName, int numberParameter, String compiler) {
		return create(cProgram, functionName, numberParameter, DEFAULT_COMPILER, Options.createOptions(DEFAULT_OPTIONS));
	}
	 ...
	 * @return created and compiled cProgram
	 */
	public static CProgram create(String cProgram, String functionName, int numberParameter, String compiler, Options options) {
	...
	private static native CProgram createInternal(String cProgram, String functionName, int numberParameter, String compiler, Options options);
