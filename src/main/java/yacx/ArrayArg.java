...
public abstract class ArrayArg extends KernelArg {
	...
	/**
	 * Slices the array. <br>
	 * This creates a new ArrayArg corresponding to a new C-KernelArg-Object, but
	 * using the same memory for the array. <br>
	 * If the content of this ArrayArg changed, the content of the created ArrayArg
	 * will be changed too. In the other direction as well.
	 * 
	 ...
	 * 
	 * @return <code>true</code> if this argument should be downloaded.
	 ...
	 * 
	 * @param download <code>true</code> if this argument should be downloaded.
	 *                 <code>false</code> otherwise
	 */
	 ...
	 * 
	 * @return <code>true</code> if this argument should be uploaded.
	 *         <code>false</code> otherwise
	 */
	 ...
	 * 
	 * @param upload <code>true</code> if this argument should be uploaded.
	 *               <code>false</code> otherwise
	 */
	 ...
	 * @return a pointer to a new C-KernelArg-Object using the same memory for the
	 *         array
	 */
