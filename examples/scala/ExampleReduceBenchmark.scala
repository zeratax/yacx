...
object ExampleReduceBenchmark {
  ...
  def main(args: Array[String]) : Unit = {
    ...
    val result = Executor.benchmark("device_reduce", options, 50, creator1, dataSizes: _*)

    // Simulate second kernel call
    val result2 = Executor.benchmark("device_reduce", options, 50, creator2, dataSizes: _*)
