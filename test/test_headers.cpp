...
//    REQUIRE(std::string{headers.names()[2]}, std::string{"test/test_pixel.hpp"});
//    REQUIRE(std::string{headers.names()[1]}, std::string{"test/test_header1.hpp"});
//    REQUIRE(std::string{headers.names()[0]}, std::string{"test/test_header2.hpp"});
...
//    REQUIRE(std::string{headers.names()[0]}, std::string{"test/test_pixel.hpp"});
//    REQUIRE(std::string{headers.names()[1]}, std::string{"test/test_header1.hpp"});
