...
TEST_CASE("The kernel - source code will be tested under the following conditions."){
    ...
    SECTION("2C. The created kernel is launched using different block and grid dimensions."){ 
        ...
        dim3 grid_test_1(1), block_test_1(5);
        dim3 grid_test_2(5),block_test_2(1);
        dim3 grid_test_3(5),block_test_3(2);
        dim3 grid_test_4(2),block_test_4(5);

        source.program("cuda_add").compile().configure(grid_test_1, block_test_1).launch(args);
        ...
        source.program("cuda_add").compile().configure(grid_test_2, block_test_2).launch(args);
        ...
        source.program("cuda_add").compile().configure(grid_test_3, block_test_3).launch(args);
        ...
        source.program("cuda_add").compile().configure(grid_test_4, block_test_4).launch(args);

        //B2D. Comparing the results
        //A. With hOut1
